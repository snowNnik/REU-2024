...
if __name__ == "__main__":
    ...
    command_line = "../REU-2024/inputs/" + str(command_line) # Builds file to read
    commandFile = open(command_line, "r") # Read file
    commands = commandFile.read().split(";") # Split into different commands
    policy = None
